...
У Codex нет загрузчика скиллов — вставь правила в `AGENTS.md` или в кастомный prompt/agent.
...
Правила собраны из источников ниже. Ссылки также встроены в `SKILL.md`.
