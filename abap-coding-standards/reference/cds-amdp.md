...
- **[P0]** Security: the class/method name — from static code; build SQLScript without concatenating external input (otherwise injection) — the rule is `security.md` (`no-sql-string-concat`). Parameters — via `:name` binding.
