...
- **[P2]** Exceptions — for errors, not for regular cases (see `errors.md`, "Error handling"). Keep complexity in check: cyclomatic complexity of a method ≤ ~15, nesting depth ≤ ~5; beyond — extract branches/guard conditions into separate methods.
