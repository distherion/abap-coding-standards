...
- **[P3]** Attributes/text of a data element (field label, length) — `cl_rec_ddic_dtel` (RE-FX, analogous to `cl_reca_ddic_doma` for fields; verify the signature in SE24). Standard fallback — FM `DDIF_DTEL_GET`.
