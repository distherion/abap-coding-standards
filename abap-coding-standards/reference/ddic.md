...
- **[info]** Append structures are a tool for enhancing **SAP** objects, not your own `Z`-tables/structures — do not extend own tables this way (your own fields there — `ZZ`/`YY`; for an SAP object look first for the Customizing Include `CI_*`); respect the enhancement category.
