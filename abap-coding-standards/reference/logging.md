...
- **[P2]** Accumulate messages, do not stop on the first: accumulate in a loop, show at the end. Presence of a needed type: `lo_msglist->has_message( id_msgty = 'E' )`; empty — `is_empty( ) = abap_false`.
